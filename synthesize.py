...
from model_multi_2 import Flowavenet
...
parser.add_argument('--num_samples', type=int, default=5, help='# of audio samples')
...
parser.add_argument('--block_per_split', type=int, default=8, help='Block per split')
