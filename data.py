...
def trim(audio, mel):
    energy = librosa.feature.rmse(audio, frame_length=256, hop_length=256, center=False)
    frames = np.nonzero(energy > 0.03)
    start_idx, end_idx = frames[1][0], frames[1][-1]
    print(start_idx, end_idx)
    return audio[start_idx * 256:end_idx * 256], mel[start_idx:end_idx]
